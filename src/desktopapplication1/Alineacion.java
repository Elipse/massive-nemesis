 ...
 */
@Entity
@Table(name = "_alineacion", catalog = "busqueda", schema = "")
@NamedQueries({
...
public class Alineacion implements Serializable {
    ...
    public void setAlineacion(String alineacion) {
        String oldAlineacion = this.alineacion;
        this.alineacion = alineacion;
        changeSupport.firePropertyChange("alineacion", oldAlineacion, alineacion);
    }
    ...
    public String toString() {
        return "desktopapplication1.Alineacion[ alineacionPK=" + alineacionPK + " ]";
    }
